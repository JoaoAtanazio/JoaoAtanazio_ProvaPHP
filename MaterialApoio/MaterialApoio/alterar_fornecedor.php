...
<body>
    ...
    <?php if($fornecedor): ?>
        ...
        <form action="processa_alteracao_fornecedor.php" method="POST">
            ...
            <input type="text" id="nome" name="nome" value="<?=htmlspecialchars($fornecedor['nome_fornecedor'])?>" required>
        ...
        <!-- SE O fornecedor LOGADO FOR ADM, EXIBIR OPCAO DE ALTERAR SENHA -->
